...
- **An AI coding assistant** — Design OS uses slash commands to guide the design process. OpenCode is recommended, but you can invoke the Design OS commands from any AI coding tool that supports custom commands or prompts (Cursor, Windsurf, Codex, etc.)
