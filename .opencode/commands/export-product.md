---
description: Export complete product handoff package
agent: build
---
...
- `/product/design-system/style-notes.md` — UI style options (density, radius, motion, contrast)
...
6. `/product/design-system/style-notes.md` (if exists)
...
:root {
  ...
  --ui-radius: [sharp|soft|rounded];
  --ui-motion: [minimal|moderate|expressive];
  --ui-contrast: [standard|high];
  --ui-chrome: [subtle|defined];
}
```
...
- stylePack: [Pack Name or "Not defined"]
- density: [compact/comfortable/spacious or "Not defined"]
- radius: [sharp/soft/rounded or "Not defined"]
- motion: [minimal/moderate/expressive or "Not defined"]
- contrast: [standard/high or "Not defined"]
- chrome: [subtle/defined or "Not defined"]
```
