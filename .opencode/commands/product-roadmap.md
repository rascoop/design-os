---
description: Create or refine product roadmap sections
agent: build
---
...
Before generating, use the `question` tool for 2-4 quick checks:

- "Which user journey should feel complete first (on day 1)?"
- "Should any section be admin-only or internal-only?"
- "Are there sections that should be split now vs combined for MVP?"
- "Do you want utility sections included (Settings, Billing, Team), or only core workflow sections?"
