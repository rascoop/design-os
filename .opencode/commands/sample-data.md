---
description: Generate or revise section sample data and types
agent: build
---
...
If there's only one section, auto-select it. If there are multiple sections, use the `question` tool to ask which section the user wants to generate data for.
