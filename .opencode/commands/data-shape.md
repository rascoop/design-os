---
description: Create or refine product entities and relationships
agent: build
---
...
Before generating, use the `question` tool for 2-4 checks:

- "Which entities are user-facing and must appear in UI copy/navigation?"
- "Which entities are supporting/internal and should stay out of first-pass UI?"
- "Are any many-to-many relationships important for UX (tagging, assignment, collaboration)?"
- "Do any entities need clear lifecycle states (draft/active/archived) reflected in the UI?"
